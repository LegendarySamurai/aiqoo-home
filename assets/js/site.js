...
document.addEventListener('readystatechange', function (event) {
    if (event.target.readyState === "complete") {
        init();
        var Icons = document.getElementById("MaterialIcons");
        Icons.rel = 'stylesheet';
        Icons.href = 'https://pro.fontawesome.com/releases/v5.12.0/css/all.css';
        Icons.integrity = 'sha384-ekOryaXPbeCpWQNxMwSWVvQ0+1VrStoPJq54shlYhR8HzQgig1v5fas6YgOqLoKz';
...
window.toggleSection = (event, sectionID) => {
...
window.testks = (instance) => {
    instance.invokeMethodAsync('JSInteropExamples', 'GetHelloMessage')
        .then(message => {
            console.log(message);
        });
}
