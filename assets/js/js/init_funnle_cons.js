...
var myExtObject = { fireConvEvent: function (n) { window.dataLayer = window.dataLayer || [], window.dataLayer.push({ event: "conv_" + n.toLowerCase() }) }, func2: function () { alert("function 2 called") } };


//UTA code
var _apiUrl = "https://api.aiq-magazine.com/api/v1/";
const _userTempCode = IdGenerator(10);
...
function getFullInformation() {
    ...
    amitObj.languages.forEach(element => {
            ...
            if (http_req.readyState == 4) {
                if (http_req.status == 200) {
                    ...
                    var timout = setTimeout(() => {
                        ...
                        alert(this.readyState + ' - bad - ' + http_req.responseText + currentRun);
                    }, 2000)
                }
            }
        };
            ...
            if (xhr.readyState === 4) {
                if (xhr.status == 200) {
                    ...
                    var timout = setTimeout(() => {
                        ...
                        console.log(this.readyState + ' - bad - ' + xhr.responseText + currentRun);
                    }, 2000)
                }
            }
        };
